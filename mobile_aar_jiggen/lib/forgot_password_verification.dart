                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10,),
                            Text(
                              'Entrer le code de vérification que nous vous avons envoyé dans votre adresse email.',
                              style: TextStyle(
                                // fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black54
                          ...
                          children: <Widget>[
                            ...
                            Text.rich(
                              TextSpan(
                                children: [
                                  TextSpan(
                                    text: "Si vous n'avez pas reçu le code! ",
                                    style: TextStyle(
                                      ...
                                      ..onTap = () {
                                        showDialog(
                                          ...
                                          builder: (BuildContext context) {
                                            return ThemeHelper().alartDialog("Succès",
                                                "Code de vérification renvoyé ave succès.",
                                                context);
                                          },
                                        );
                                      },

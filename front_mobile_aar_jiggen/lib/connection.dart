                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                ...
                                child: Padding(
                                  ...
                                  child: Text('Se connecter'.toUpperCase(), style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),),
                                ),
                                onPressed: (){
                                  //After successful login we will redirect to profile page. Let's create profile page now
                                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => AccueilScreen()));
                                },
                              ),
                            ),
                            Container(
                              ...
                              child: Text.rich(
                                TextSpan(
                                  children: [
                                    TextSpan(text: "Vous n'avez pas encore de compre? "),
                                    TextSpan(
                                      text: 'S\'inscrire',

 ...
 */
final class Version20220307034046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne_confiance ADD itineraire_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_AF8469FAA9B853B8 ON personne_confiance (itineraire_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_AF8469FAA9B853B8 ON personne_confiance');
        $this->addSql('ALTER TABLE personne_confiance DROP itineraire_id, CHANGE nom_complet nom_complet VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE telephone telephone VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE statut statut VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
